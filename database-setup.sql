-- AI Auditor GRC Database Schema
...
-- Add foreign key constraint for users.business_unit_id
ALTER TABLE users ADD CONSTRAINT fk_users_business_unit
...
-- Insert sample users (Note: These would typically be created through the auth flow)
