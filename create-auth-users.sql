-- Comprehensive User Creation Script for Audit System
...
-- Success message
SELECT 'SUCCESS: 10 users and 6 business units created successfully! You can now create audits.' as message;

-- Login credentials for testing (all passwords are formatted as: RolePass123!)
